...
Dead Air was a mod created by TonisGaming that has been discontinued, this project aims to revive it.
...
2. Install [ModComponent](https://github.com/dommrogers/ModComponent), [ModSettings](https://github.com/DigitalzombieTLD/ModSettings/) and [ModData](https://github.com/dommrogers/ModData).
3. Place `DeadAirReborn.dll` inside your Mods folder.
